...
DATA = Path("../data/earthquake_data/eq_data_past_30_days_m4plus.geojson")
if not DATA.exists():
    sys.exit(
        "Missing data file: data/earthquake_data/eq_data_past_30_days_m4plus.geojson\n"
        "See data/README.md for download instructions."
    )

# Read data as a string and convert it to a Python object.
path = Path('../data/earthquake_data/eq_data_past_30_days_m4plus.geojson')
