...
DATA = Path("../data/wildfire_data/world_fires_7_day.csv")
if not DATA.exists():
    sys.exit(
        "Missing data file: data/wildfire_data/world_fires_7_day.csv\n"
        "See data/README.md for download instructions."
    )

# Read data
path = Path('../data/wildfire_data/world_fires_7_day.csv')
