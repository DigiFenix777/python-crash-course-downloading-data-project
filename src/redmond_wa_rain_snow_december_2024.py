...
DATA = Path("../data/weather_data/redmond_wa_2024_simple.csv")
if not DATA.exists():
    sys.exit(
        "Missing data file: data/weather_data/redmond_wa_2024_simple.csv\n"
        "See data/README.md for download instructions."
    )

path = Path('../data/weather_data/redmond_wa_2024_simple.csv')
